...
public class StringECP {
     ...
     */
    /*public  void testUsingSecretKey() {
        try {
            System.out.println();
            System.out.println("+----------------------------------------+");
    ...
    public void testUsingPassPhrase() {
        // Create encrypter/decrypter class
        StringECP desEncrypter = new StringECP(secret);
        // Encrypt the string
        String desEncrypted       = desEncrypter.encrypt(secret);
        // Decrypt the string
        String desDecrypted       = desEncrypter.decrypt(desEncrypted);
        // Print out values
