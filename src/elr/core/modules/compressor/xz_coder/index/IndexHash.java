...
import elr.core.modules.compressor.xz_coder.xz.XZIOException;
import elr.core.modules.compressor.xz_coder.xz.CorruptedInputException;

public class IndexHash extends IndexBase {
    private elr.core.modules.compressor.xz_coder.check.Check hash;

    public IndexHash() {
        super(new CorruptedInputException());

        try {
            hash = new elr.core.modules.compressor.xz_coder.check.SHA256();
        } catch (java.security.NoSuchAlgorithmException e) {
            hash = new elr.core.modules.compressor.xz_coder.check.CRC32();
        }
    }
